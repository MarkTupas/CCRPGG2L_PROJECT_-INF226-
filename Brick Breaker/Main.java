...
public class Main{
    ...
    public static void theme1() {
        ...
        ball_color = Color.decode("#FFA500");
    ...
    public static void about() {
        Icon icon = new ImageIcon("dp.png");
    ...
    public static void aboutMembers() {
    ...
    public static void select_level() {
        GamePlay.play = false;
        int result = JOptionPane.showConfirmDialog(frame, "Do you want to start new game?", "Restart Game", JOptionPane.YES_OPTION, JOptionPane.NO_OPTION);
        ...
        MenuItem about_2 = new MenuItem("Members");
        menuBar.add(menu1);
        menuBar.add(menu2);
        menuBar.add(menu3);
        ...
        about_2.addActionListener(action -> {
            boolean temp = GamePlay.play;
            if (temp) {
                GamePlay.play = false;
                aboutMembers();
